...
from kivy.uix.image import Image  # Importação da imagem padrão
...
class TelaInicial(MDScreen):
    def __init__(self, **kwargs):
        ...
        # CAMADA 1 (Fundo): Sua imagem cobrindo a tela inteira por trás de tudo
        imagem_fundo = Image(
            source='fundo.png',  # <<< Seu arquivo configurado aqui
            allow_stretch=True,
            keep_ratio=False,
            size_hint=(1, 1),
        ...
        # CAMADA 2 (Frente): O cartão com visual "vidro fumê" (semi-transparente)
        cartao = MDCard(
            ...
            md_bg_color=(0.15, 0.15, 0.18, 0.85),  # 85% de opacidade para o fundo aparecer levemente
            elevation=4,
            radius=[24, 24, 24, 24]
        )
